...
public class KenmerkGetById extends SimpleWebrequest<Kenmerk> {
    ...
    public KenmerkGetById(String id, Response.Listener<Kenmerk> uitvoerenIndienGeslaagd, Response.ErrorListener uitvoerenIndienNietGeslaagd) {
        ...
        this.teVerzendenParameters.put("id", id);
    }
}
