...
import swarm_app_3.ehb.com.contourtheapp.Activities.HomeScreen;
import swarm_app_3.ehb.com.contourtheapp.Activities.MapsActivity;
import swarm_app_3.ehb.com.contourtheapp.Activities.Register1Basic;
import swarm_app_3.ehb.com.contourtheapp.R;


public class OpenMoreInfoSwarmDialog extends Dialog implements android.view.View.OnClickListener {

    public Activity activity;
    public Button subscribeButton;

    public OpenMoreInfoSwarmDialog() {
        super(null);
    }

    public OpenMoreInfoSwarmDialog(Activity activity) {
        super(activity);
